                    ...
                    <header className="border-b border-gray-200 bg-white px-6 py-4">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2 text-sm">
                                <Link href="/student/courses" className="text-gray-500 hover:text-gray-900">
                                    My Courses
                                </Link>
                            ...
                            <div className="flex flex-col items-end gap-1">
                                <div className="w-32 h-1 bg-gray-200 rounded-full overflow-hidden">
                                    <div
                                        ...
                                        style={{ width: `${courseData.progress || 1}%` }}
                                    />
                                </div>
                                <span className="text-xs text-gray-500">{courseData.progress}% completed</span>
                            </div>
                        </div>
                    </header>
                            ...
                            <div className="container mx-auto px-6 py-6">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <button
                                        ...
                                        className={`w-full sm:w-auto px-6 py-3 rounded-lg font-bold text-white transition-colors flex items-center justify-center gap-2 ${isCompleted
